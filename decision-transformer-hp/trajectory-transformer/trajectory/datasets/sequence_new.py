...
class SequenceDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, env, human_pref=False, sequence_length=250, step=10, discount=0.99, max_path_length=1000, penalty=None, device='cuda:0'):
        ...
        dataset = qlearning_dataset_with_timeouts(env.unwrapped, terminate_on_end=False)
        print('✓')
        ...
        if human_pref:
            with open('pref_reward/reward_hf_{}.pkl'.format(self.env.name), 'rb') as f:
            ...
            realterminals = dataset['dones'].astype(bool)
